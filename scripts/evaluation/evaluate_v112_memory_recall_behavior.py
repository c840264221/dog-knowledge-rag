...
async def run_memory_recall_behavior_evaluation(
    dataset_path: Path = DEFAULT_DATASET_PATH,
) -> int:
    """
    执行 V1.12.5 Memory Recall 行为黄金集评估。
    ...
    print("=" * 80)
    print("V1.12.5 Memory Recall Behavior Evaluation Report")
    print("=" * 80)
...
def main() -> None:
    ...
    exit_code = asyncio.run(
        run_memory_recall_behavior_evaluation()
    )
